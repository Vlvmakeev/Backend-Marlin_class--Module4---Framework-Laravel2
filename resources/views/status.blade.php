                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div hidden class="form-group">
                                            ...
                                            <input type="text" id="id" name="id" class="form-control" value="<?php echo $status->user_id; ?>">
                                        </div>
                                        <!-- status -->
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="status" name="status" ?>
                                                <option <?php echo ($status->status == 'Онлайн') ? 'selected' : ''; ?> >Онлайн</option>
                                                <option <?php echo ($status->status == 'Отошел') ? 'selected' : ''; ?> >Отошел</option>
                                                <option <?php echo ($status->status == 'Не беспокоить') ? 'selected' : ''; ?>>Не беспокоить</option>
                                            </select>
                                        </div>
                                    </div>

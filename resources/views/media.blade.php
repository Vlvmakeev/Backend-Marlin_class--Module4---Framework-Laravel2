...
<head>
    <meta charset="UTF-8">
    <title>Изменение аватарки</title>
...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form enctype="multipart/form-data" action="/change_image" method="post">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                <div class="form-group">
                                    <img src="../<?php echo ($user->image->image != null) ? $user->image->image : '../public/img/demo/avatars/avatar-m.png'; ?>" alt="Аватар пользователя" class="img-responsive" width="200">
                                </div>
                                <div hidden class="form-group">
                                    <label class="form-label" for="id"></label>
                                    <input type="text" id="id" name="id" class="form-control-file" value="{{ $user->id }}">
                                </div>
                                <div class="form-group">

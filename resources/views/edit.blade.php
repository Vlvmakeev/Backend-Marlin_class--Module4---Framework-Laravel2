                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div hidden class="form-group">
                                    ...
                                    <input type="text" id="id" name="id" class="form-control" value="{{ $info->user->id }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="job" name="job" class="form-control" value="{{ $info->job }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="adress" name="address" class="form-control" value="{{ $info->address }}">
                                </div>
